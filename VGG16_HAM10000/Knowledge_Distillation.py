...
def train_student_with_distillation(teacher, student, train_loader, test_loader, optimizer_student, criterion_teacher, criterion_student, temperature=4, alpha=0.5, num_epochs=20):
    ...
    for epoch in range(num_epochs):
        ...
        for i, (inputs, labels) in enumerate(train_loader, 0):
            ...
            if i % 100 == 99:
                print(f'Student: Epoch {epoch+1}, Batch {i+1}: Loss {running_loss/100:.3f}')
                running_loss = 0.0
        ...
        print(f'Student: Epoch {epoch+1}, Test Accuracy: {correct/total*100:.2f}%')
