...
# you can use the SubsetRandomSampler to create a subset of the test loader
# subset_sampler = SubsetRandomSampler(range(2000))
# subset_loader = DataLoader(
#     test_loader.dataset, batch_size=16, sampler=subset_sampler)


layers = ['features.conv0', 'features.denseblock1.denselayer1.conv1',
